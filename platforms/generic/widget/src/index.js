...
class DocuskribeWidget extends HTMLElement {
  ...
  getStyles() {
    ...
    return `
      ...
      .docuskribe-btn:hover:not(:disabled) {
        background-color: #0f5edb;
        transform: translateY(-1px);
        box-shadow: 0 4px 8px rgba(0, 0, 0, 0.15);
      }

      .docuskribe-btn:active:not(:disabled) {
        transform: translateY(0);
      }

      .docuskribe-btn:disabled {
...
customElements.define('docuskribe-widget', DocuskribeWidget);
